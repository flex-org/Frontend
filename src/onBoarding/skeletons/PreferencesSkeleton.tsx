    ...
    return (
        <div className="flex w-full flex-col gap-4 px-2 pb-20 sm:px-0">
                        ...
                        {[1, 2].map((num) => (
                            <div key={num} className="space-y-4">
                                ...
                                <div className="relative flex items-center py-2">
                                    ...
                                    <Skeleton
                                        className="absolute h-5 w-5 rounded-full border-2 border-white bg-green-600 dark:bg-green-500"
                                        style={{ left: '0%' }}
                                    />
                                </div>
                                {/* Hint Text */}
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="space-y-3">
                                {[1, 2, 3].map((i) => (
                                    ...
                                    >
                                        <Skeleton className="h-5 w-5 rounded bg-gray-300 dark:bg-green-800" />
            ...
            <div className="flex w-full justify-between">
                <Skeleton className="h-10 w-20 rounded bg-gray-300 dark:bg-green-800" />
                <Skeleton className="h-10 w-25 rounded bg-gray-300 dark:bg-green-800" />
            </div>
        </div>
    );
};
